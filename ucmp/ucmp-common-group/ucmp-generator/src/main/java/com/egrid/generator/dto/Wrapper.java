...
public class Wrapper {
	...
	public Wrapper(IntrospectedTable arg0, String tablePrefixOverrides, String serviceName, String moduleName, String basePackagePath) {
		this.tableInfo = arg0;
		...
		daoName = "I"+StringUtility.getCamelCaseString(tableName, true) + "Dao";
		daoVar = StringUtility.getCamelCaseString(tableName, false) + "Dao";
		daoPackagePath = basePackagePath + ".dao";
