...
public class RepReplacementMaterialFilePk extends AbstractBasePk {
    ...
    public RepReplacementMaterialFilePk() {
    }
    
    public RepReplacementMaterialFilePk(Long materialFileId) {
