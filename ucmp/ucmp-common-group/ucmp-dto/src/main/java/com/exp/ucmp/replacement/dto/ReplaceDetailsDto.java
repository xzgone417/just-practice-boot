...
@ApiModel(value = "ReplaceDetailsDto", description = "置换单详情实体类")
public class ReplaceDetailsDto {
	...
	private List<TakeOrdersDto> takeOrdersDto;
	
	@ApiModelProperty(value = "报价记录")
	private List<QuoteRecordDto> quoteRecordDto;
	
	@ApiModelProperty(value = "收购记录")
	private List<AcquisitionRecordDto> acquisitionRecordDto;
	...
	public List<TakeOrdersDto> getTakeOrdersDto() {
		return takeOrdersDto;
	}

	public void setTakeOrdersDto(List<TakeOrdersDto> takeOrdersDto) {
		this.takeOrdersDto = takeOrdersDto;
	}

	public List<QuoteRecordDto> getQuoteRecordDto() {
		return quoteRecordDto;
	}

	public void setQuoteRecordDto(List<QuoteRecordDto> quoteRecordDto) {
		this.quoteRecordDto = quoteRecordDto;
	}

	public List<AcquisitionRecordDto> getAcquisitionRecordDto() {
		return acquisitionRecordDto;
	}

	public void setAcquisitionRecordDto(List<AcquisitionRecordDto> acquisitionRecordDto) {
