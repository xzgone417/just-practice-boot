...
@ApiModel(value = "OrderChangeFileDto", description = "订单改价材料参数类")
public class OrderChangeFileDto {
    ...
    @ApiModelProperty(value = "缩略图,不用传")
    private String thumbnail;
    
    @ApiModelProperty(value = "材料类型 3301")
    private String materialType;
    
    @ApiModelProperty(value = "材料类型名称,不用传")
    private String materialTypeName;
    
    @ApiModelProperty(value = "文件链接,不用传")
