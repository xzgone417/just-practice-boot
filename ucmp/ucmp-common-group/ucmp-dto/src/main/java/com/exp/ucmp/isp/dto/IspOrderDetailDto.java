...
@ApiModel(value = "IspOrderDetailDto", description = "isp报价单申请返回类")
public class IspOrderDetailDto {
	
	@ApiModelProperty(value = "主键")
	private long id;
	
	@ApiModelProperty(value = "维修项目")
    private List<IspOrderMaintenanceItemsDto> maintenanceItems;
	
	@ApiModelProperty(value = "维修配件")
    private List<IspOrderPartsDto> parts;
	
	@ApiModelProperty(value = "其他费用")
    private List<IspOrderAdditionalItemsDto> additionalItems;
	...
	public List<IspOrderMaintenanceItemsDto> getMaintenanceItems() {
		return maintenanceItems;
	}

	public void setMaintenanceItems(List<IspOrderMaintenanceItemsDto> maintenanceItems) {
		this.maintenanceItems = maintenanceItems;
	}

	public List<IspOrderPartsDto> getParts() {
		return parts;
	}

	public void setParts(List<IspOrderPartsDto> parts) {
		this.parts = parts;
	}

	public List<IspOrderAdditionalItemsDto> getAdditionalItems() {
		return additionalItems;
	}

	public void setAdditionalItems(List<IspOrderAdditionalItemsDto> additionalItems) {
