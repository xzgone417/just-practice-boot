package com.exp.ucmp.file.utils;
...
public class FileUtil {
    ...
    //压缩并转码
    public static String compressToBASE64(MultipartFile file) throws Exception {
    	try{
	...
	public static void main(String[] args) {
		String fileName = "2181d666-62eb-4a1b-afde-3b70cb364074-C2D.txt";
